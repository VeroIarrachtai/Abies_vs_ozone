...
# Make table with over and down expressed in DAMAGED
...
# General
write.table(df_general, "../../data/Over_Down/GENERAL_C_TvsD_inDamaged.txt", sep="\t", row.names=T)
...
ggplot(df_general, aes(x=logFC_ER, y=sig_ER)) +
  ...
  geom_vline(xintercept = -1, colour = "black", linetype = "dashed", size = 0.25)  # Vertical significance cut-off line (+).
  ggsave("../../outputs/8_1_VP_General_sinN_C_TvsD.tiff")
